...
public class AllReportsFragment extends Fragment {
    ...
    public static final String TAG = AllReportsFragment.class.getSimpleName();
...
//
//        // get the state of the friendsListFetched from the saved instance
//        if (savedInstanceState == null) {
//
//        } else {
//            friendsListFetched = savedInstanceState.getBoolean("friendsListFetched");
//            listItemArray =  savedInstanceState.getParcelableArrayList("listItems");
//
//            forRowsInList();
    ...
    private void getAllReports(final Boolean isRefresh){
        ...
        if(isloading == false) {
            ...
            Request request = new Request.Builder()
                    .url(new Endpoints().base_url+"comments?offset=1&type=other&size=30")
                        ...
                        try {
                            ...
                            try {
                                ...
                                for (int i = 0; i < spazaList.length(); i++) {
                                    ...
                                    listItemContents.setReportType("reported an incident");
