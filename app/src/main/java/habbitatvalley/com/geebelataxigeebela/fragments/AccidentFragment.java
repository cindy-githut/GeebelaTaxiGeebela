...
public class AccidentFragment extends Fragment {
    ...
    public static final String TAG = AccidentFragment.class.getSimpleName();
        ...
        if(isloading == false) {
           ...
           // new ApiHearders().addMultipleHearders(getActivity(),httpClient);
            ...
            Request request = new Request.Builder()
                    .url(new Endpoints().base_url+"comments/?&type=accident&size=30")
                        ...
                        try {
                            ...
                            try {
                                ...
                                for (int i = 0; i < spazaList.length(); i++) {
                                    ...
                                    listItemContents.setReportType("reported an accident");
                                    if (i == 0) {
